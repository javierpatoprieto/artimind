...
export const ui = {
  es: {
    ...
    "xfeed.eyebrow": "En vivo",
    "xfeed.title": "Lo último en X",
    "xfeed.sub": "Comparto trabajo, procesos y experimentos casi a diario. Este es mi patio de juegos visual.",
    "xfeed.cta": "Seguir en X",
  ...
  en: {
    ...
    "xfeed.eyebrow": "Live",
    "xfeed.title": "Latest on X",
    "xfeed.sub": "I share work, process and experiments almost daily. This is my visual playground.",
    "xfeed.cta": "Follow on X",
